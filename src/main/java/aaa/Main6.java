    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < boxes.size(); i++) {
            ...
            if (lastX + box.width <= warehouseWidth) {
                // Ha a szélesség meghaladja a tároló szélességét, akkor a következő sorba lépünk
                if (lastY + box.length <= warehouseLength) {
                    // Ha a hosszúság is elfér, akkor a dobozt elhelyezzük
                    if (lastZ + box.height <= warehouseHeight) {
                        // Ha a magasság is elfér, elhelyezzük a dobozt
                        ...
                        // Ha a magasság nem fér el, akkor marad a doboz a maradó dobozok között
                        remainingBoxes.add(box);
                    }
                } else {
                    // Ha a hosszúság nem fér el, akkor új sort kezdünk
                    lastY = 0;
                    lastX += box.width;  // Szélesség növelése
                ...
                // Ha a doboz nem fér el, akkor marad a maradó dobozok között
                remainingBoxes.add(box);
            }
        }
